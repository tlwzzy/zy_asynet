...
class AbstractTrainer(abc.ABC):
    def __init__(self, settings):
        ...
        elif self.settings.event_representation == 'concat':
            self.nr_input_channels = 32
        elif self.settings.event_representation == 'voxel_grid':
            self.nr_input_channels = 5
        elif self.settings.event_representation == 'voxel_grid_cat_gistogram':
            self.nr_input_channels = 7
        elif self.settings.event_representation == 'hist_cat_voxel':
            self.nr_input_channels = 7
